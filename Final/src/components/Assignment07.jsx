...
const FileUploadForm = () => {
  ...
  const { 
    ...
    defaultValues: {
      searchType: 'interference' // Default to content search
    }
  });
        ...
        <div className="form-group">
          ...
          <Controller
            ...
            render={({ field }) => (
              ...
              >
                <Select.Option value="belief">Belief</Select.Option>
                <Select.Option value="interference">Interference</Select.Option>
