...
const FileUploadForm = () => {
  ...
  const { 
    ...
    defaultValues: {
      searchType: 'bim' // Default to content search
    }
  });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:5000/api/${data.searchType}`, payload);
        ...
        <div className="form-group">
          ...
          <Controller
            ...
            render={({ field }) => (
              ...
              >
                <Select.Option value="bim">BIM</Select.Option>
                <Select.Option value="non-overlapping-search">Non-Overlapped List</Select.Option>
